...
1. INTRODUCTION
These terms and conditions ("Terms") govern your access to and use of the website www.muditam.com
, the Muditam mobile application (together, the "Platform"), and any services or products made available through the Platform by Muditam Ayurveda Private Limited ("Muditam", "we", "us", or "our").
...
Use of the Platform is permitted only to individuals who are capable of entering into legally binding contracts under the Indian Contract Act, 1872. Persons who are “incompetent to contract” (e.g., minors, un-discharged insolvents, etc.) are not eligible to use the Platform.
...
All content, communication, and recommendations, including any predictions, are for general wellness and informational purposes.
...
.
By using our Platform, you consent to our collection and use of your personal data for generating general wellness predictions and offering personalized wellness services.

19. MODIFICATION OF TERMS
Muditam may modify these Terms at any time. Updated versions will be posted on the Platform. Continued use after changes constitutes your acceptance. If we update the Terms to include changes to the prediction feature, we will clearly notify users and ask for consent.
...
For exercising any rights, please email hello@muditam.com
...
12. PREDICTION DISCLAIMER
The predictions generated by the Platform, based on user input, are for general wellness insights and lifestyle recommendations only. These predictions are not clinically validated and are not intended to diagnose, treat, or cure any medical condition.
By using the Platform, you acknowledge that the predictions are not a substitute for professional medical advice. We strongly advise users to consult with healthcare professionals before making any medical, health, or wellness decisions based on the predictions.
